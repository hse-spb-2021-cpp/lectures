...
## 6. `unique_ptr`
* Отличия `unique_ptr` от обычного указателя
...
* Использование функторов.
  ...
  * Сохранение в поле класса при помощи `std::function` или по точному типу.
* Лямбда-функции (C++11):
...
* Необходимость совпадения стандартных библиотек при компиляции
  * Не было: необходимость динамической линковки стандартной библиотеки
...
* конструктор копирования и перемещения, копирующий и перемещающий оператор присваивания, правило пяти
